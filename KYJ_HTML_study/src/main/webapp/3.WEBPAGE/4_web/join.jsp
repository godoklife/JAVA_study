...
<body>
	...
	<div class="container text-left">
		<form action="#" method="get" class= "row align-items-start">
			<div class="col-md-6">
				<div class="py-2" id="line">
					<div id="fontbold" >회원가입 및 정상적인 서비스 이용을 위해 아래 약관을 읽어 보시고,<br> 동의 여부를 결정해 주세요</div>
					<div id="fontgray">필수 약관을 동의 하셔야 회원가입이 가능합니다.</div>
				</div>
				<div>
					<h3>회원가입 약관동의</h3>
				</div>
				<div class="col-md-12" id="bottomline">
					<textarea rows="10" cols="" class="form-control" style="resize:none;" readonly>
제 1장 총칙
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.</textarea>
					<input type = "checkbox" class="m-3"> 회원가입 약관 동의 합니다.
				</div>
				<h3 class="my-2"> 개인정보처리방침</h3>
				<div class="col-md-12">
					<textarea rows="10" cols="" class="form-control" style="resize:none;" readonly>
가. 개인정보의 수집 및 이용 목적
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
					...
					<input type = "checkbox" class="m-3"> 개인정보처리방침 동의 합니다.
				</div>
			</div>
			<div class="col-md-6" id="join">
				<div class="row" >
					<div class="col-md-12">
						<input class="form-control" type="text" placeholder="아이디를 입력하세요." maxlength="32">
					</div>
					<div class="col-md-12">
						<input class="form-control" type="password" placeholder="비밀번호를 입력하세요." maxlength="32">
					</div>
					<div class="col-md-12">
						<input class="form-control" type="password" placeholder="한번 더 비밀번호를 입력하세요." maxlength="32">
					</div>
					<div>
						<input class="form-control" type="text" placeholder="이름을 입력하세요" maxlength="12">
					</div>
					<div class="col-md-12 text-center" >
						<input type="radio" name="sex"> 남자 <input type="radio" name="sex"> 여자 
					</div>
					<div>
						<input class="form-control" type="text" placeholder="연락처를 입력하세요" maxlength="20">
					</div>
					<div>
						<input class="form-control" type="text" placeholder="이메일을 입력하세요" maxlength="40">
					</div>
					<div>
						<input class="form-control" type="number" placeholder="나이를 입력하세요" maxlength="3">
					</div>
					<div class="row">
						<div class="col-md-3">
							주소
					...
					<button class="form-control text-center" type="submit"> 회원가입 </button>
				</div>
			</div>
		</form>									
	</div>
