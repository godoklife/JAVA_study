...
<body>
	...
	<div class = "container">
		<div class = "row">
			...
			<div style="background-color: black;" class="carousel-indicators">
				...
				<!-- 이전(왼쪽)버튼 -->
				<button style="background-color: black;" class="carousel-control-prev" type="button" data-bs-target="#mainslide" data-bs-slide="prev">
					<span class="carousel-control-prev-icon"></span>
				</button>
				<!-- 다음(오른쪽)버튼 -->
				<button style="background-color: black;" class="carousel-control-next" type="button" data-bs-target="#mainslide" data-bs-slide="next">
